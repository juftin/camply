...
6. **Closing**: Update the global **[docs/CHECKLIST.md](docs/CHECKLIST.md)** before finalizing your PR.
...
- `docs/`: Unified documentation and design blueprints.
...
- [ ] **Documentation Updated**: If any core logic or APIs changed, `docs/` and OpenAPI specifications are updated accordingly.
