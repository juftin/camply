        ...
        <div className="container mx-auto py-12 px-4 max-w-6xl">
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                    ...
                    nature. Our mission is to tear down the barriers that keep people
                    from accessing the outdoor spaces they love.
                </p>
            </div>
                    ...
                    <CardContent className="space-y-6">
                        <div>
                            ...
                            <p className="text-muted-foreground mb-4">
                                ...
                                flexible schedules and constant internet access. The result is that
                                working families, first-time campers, and those without
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground mb-4">
                                ...
                                in. We monitor these campgrounds 24/7, so you don't have to.
                                Our goal is to level the playing field and give everyone equal
                            ...
                            <div className="space-y-6 text-muted-foreground">
                                ...
                                <div className="bg-background/50 rounded-lg mt-8">
                                    ...
                                    <p className="text-lg leading-relaxed mb-2">
                                        ...
                                        secure a campsite everywhere we traveled throughout the trip.
                                    </p>
